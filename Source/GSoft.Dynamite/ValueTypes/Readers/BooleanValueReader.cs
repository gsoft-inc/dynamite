...
{
    /// <summary>
    /// Reads bool-based field values
    /// </summary>
    public class BooleanValueReader : BaseValueReader<bool?>
    {
        /// <summary>
        ...
        public override bool? ReadValueFromListItem(SPListItem item, string fieldInternalName)
        {
        ...
        /// <param name="fieldInternalName">The key to find the field in the item's columns</param>
        /// <returns>The value extracted from the list item's field</returns>
        public override bool? ReadValueFromListItemVersion(SPListItemVersion itemVersion, string fieldInternalName)
        {
        ...
        public override bool? ReadValueFromCamlResultDataRow(SPWeb web, DataRow dataRowFromCamlResult, string fieldInternalName)
        {
