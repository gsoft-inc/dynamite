...
{
    /// <summary>
    /// Reads Guid-based field values
    /// </summary>
    public class GuidValueReader : BaseValueReader<Guid?>
    {
        /// <summary>
        ...
        public override Guid? ReadValueFromListItem(SPListItem item, string fieldInternalName)
        {
        ...
        /// <param name="fieldInternalName">The key to find the field in the item's columns</param>
        /// <returns>The value extracted from the list item's field</returns>
        public override Guid? ReadValueFromListItemVersion(SPListItemVersion itemVersion, string fieldInternalName)
        {
        ...
        public override Guid? ReadValueFromCamlResultDataRow(SPWeb web, DataRow dataRowFromCamlResult, string fieldInternalName)
        {
            var fieldValue = dataRowFromCamlResult[fieldInternalName];

            if (fieldValue != null)
            {
                return Guid.Parse(fieldValue.ToString());
            }
