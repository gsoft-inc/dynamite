...
{
    /// <summary>
    /// Writes int-based values to SharePoint list items, field definition's DefaultValue
    /// and folder MetadataDefaults.
    /// </summary>
    public class IntegerValueWriter : BaseValueWriter<int?>
    {
        /// <summary>
        ...
        {
            var typedFieldValue = (int?)fieldValueInfo.Value;
        ...
        {
            var defaultValue = (int?)fieldValueInfo.Value;
