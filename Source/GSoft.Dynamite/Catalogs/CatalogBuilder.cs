...
namespace GSoft.Dynamite.Catalogs
{
    ...
    /// </summary>
    //[Obsolete("Use CatalogHelper instead.")]
    ...
    //    public CatalogBuilder(ILogger logger, IListHelper listHelper, ITaxonomyHelper taxonomyHelper, IContentTypeHelper contentTypeHelper)
    //    {
    //        this.logger = logger;
