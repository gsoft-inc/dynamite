...
namespace GSoft.Dynamite.Catalogs
{
    ...
    public class CatalogHelper : ICatalogHelper
    {
        ...
        /// </returns>
        private SPList SetListAsCatalog(SPList list, IEnumerable<string> availableFields)
        {
        ...
        private SPList SetListAsCatalog(SPList list, IEnumerable<string> availableFields, string taxonomyFieldMap)
        {
        ...
        /// The SharePoint list configured as a catalog.
        /// </returns>
        private SPList SetListAsCatalog(SPList list, IEnumerable<string> availableFields, string taxonomyFieldMap, bool activateAnonymousAccess)
        {
            this.logger.Info("Start method 'SetListAsCatalog' for list: '{0}'", list.RootFolder.Url);
