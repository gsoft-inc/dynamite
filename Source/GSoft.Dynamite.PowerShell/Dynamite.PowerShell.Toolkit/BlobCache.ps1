...
function Disable-DSPBlobCache {
 ...
 <#
    .SYNOPSIS
        Flush the BLOB cache on the specified Web Application

    .DESCRIPTION
        Flush the BLOB cache on the specified Web Application
        * Must be db_owner on the Web Application Database
    ...
    .EXAMPLE
        PS C:\> Clear-DSPBlobCache -WebApplication "http://sp2013"
