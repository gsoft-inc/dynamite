...
<#
	...
	.OUTPUTS
        ...
        <Configuration>
          <Web Name="Home" Path="/" Template="BLANKINTERNET#0" IsRoot="True" Owner="office\joe.blow" Language="1036">
            <Web Name="Sub Web 1" Path="subweb1" Template="CMSPUBLISHING#0" Language="1036">
              <Web Name="Sub Sub Web 1" Path="subweb11" Template="CMSPUBLISHING#0" Language="1036">
              </Web>
            </Web>
            <Web Name="Sub Web 2" Path="subweb2" Template="CMSPUBLISHING#0" Language="1036">
            </Web>
          </Web>
        </Configuration>
